  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior='height'>
      ...
      <View style={styles.innerContainer}>
        ...
        <TextInput style={styles.input} autoComplete='username' onChangeText={value => handleChange('username', value)} value={inputs.username} placeholder='Enter your username'/>
